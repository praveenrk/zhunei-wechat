...
public class UpdateManager {
	...
	private boolean isUpdate() {
		...
		return newVerCode > PublicFunction.getVerCode(mContext) ? true : false;
			...
			try {
				...
				if (Environment.getExternalStorageState().equals(
					...
					String sdpath = Environment.getExternalStorageDirectory()
							+ "/";
					mSavePath = sdpath + "PrayEveryday";
					URL url = new URL(PrayInEveryday.SERVER_URL
							+ "download/PrayInEveryday.apk");
					// 创建连接

...
public class LiturgicDay extends Date
{
    ...
    public season_t getSeason(){ return season; }
    public void setSeason(season_t s){ season = s; }

	//获取礼仪年第N主日
	public int getWeekOfSeason() { return weekOfSeason; }
	//设置礼仪年第N主日
	public void setWeekOfSeason(int w){ weekOfSeason = w; }
	...
	public color_t getColor()
	{
		...
		while(iter.hasNext())
		{
			Map.Entry<rank_t, CellInfo> entry = (Map.Entry<rank_t, CellInfo>)iter.next();

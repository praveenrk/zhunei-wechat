...
public class DownloadManager extends Thread {
    ...
    public void addTask(String url, String path) {
        ...
        try {
            addTask(newDownloadTask(url, path));
    ...
    public void checkUncompleteTasks() {
        ...
        if (urlList.size() >= 0) {
            for (int i = 0; i < urlList.size(); i++) {
                addTask(urlList.get(i).get("url"), urlList.get(i).get("path"));
            }
        }
    }
     ...
     */
    private DownloadTask newDownloadTask(String url, String path) throws MalformedURLException {
        ...
        DownloadTaskListener taskListener = new DownloadTaskListener() {
            ...
            public void updateProcess(DownloadTask task) {
                ...
                updateIntent.putExtra(MyIntents.PATH, task.getPath());
            ...
            public void preDownload(DownloadTask task) {
                ...
                ConfigUtils.storeURL(mContext, mDownloadingTasks.indexOf(task), task.getUrl(), task.getPath());
            }
        ...
        return new DownloadTask(mContext, url, path, taskListener);
    }

...
- (void)playAudioWithVolume:(NSInteger)volume Chapter:(NSInteger)chapter
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://media.cathassist.org/bible/mp3/cn/female/%03d/%03d.mp3",
                           volume+1,
                           chapter+1];
    
    NSString *urlString_male = [NSString stringWithFormat:@"http://media.cathassist.org/bible/mp3/cn/male/%03d/%03d.mp3",
                                volume+1,
                                chapter+1];
